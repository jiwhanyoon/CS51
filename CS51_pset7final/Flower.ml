...
object (self)
  ...
  method private do_action =
    ...
    Helpers.with_inv_probability World.rand bloom_probability
      begin fun () ->
        World.spawn 2 self#get_pos (fun p -> ignore (new flower p pollen_id))
      end
  ...
  (* ### TODO: Part 4 Aging ### *)
(*   method draw = self#draw_circle (Graphics.rgb 255 150 255) 
    Graphics.black (string_of_int pollen); self#draw *)
